...
ChannelModel.prototype.close = function () {
  var self = this;
...
ChannelModel.prototype.createChannel = function () {
  debug('createChannel');
  var self = this;
...
// API procedures.
Channel.prototype.rpc = function (method, fields, expect) {
  debug('rpc:', method);
  var self = this;
...
Channel.prototype.bindQueue = function (queue, source, pattern, argt) {
  return this.rpc(defs.QueueBind,
    Args.bindQueue(queue, source, pattern, argt),
    defs.QueueBindOk);
};

Channel.prototype.unbindQueue = function (queue, source, pattern, argt) {
...
Channel.prototype.deleteExchange = function (name, options) {
  return this.rpc(defs.ExchangeDelete,
    Args.deleteExchange(name, options),
    defs.ExchangeDeleteOk);
};

Channel.prototype.bindExchange = function (dest, source, pattern, argt) {
  return this.rpc(defs.ExchangeBind,
    Args.bindExchange(dest, source, pattern, argt),
    defs.ExchangeBindOk);
};

Channel.prototype.unbindExchange = function (dest, source, pattern, argt) {
...
ChannelModel.prototype.createConfirmChannel = function () {
